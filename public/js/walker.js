...
Walker.prototype = {
    ...
    update: function()
    {
        ...
        this.vx = this.vx > MAX_SPEED/64 ? MAX_SPEED/64 : this.vx < -MAX_SPEED/64 ? -MAX_SPEED/64 : this.vx;
        this.vy = this.vy > MAX_SPEED/64 ? MAX_SPEED/64 : this.vy < -MAX_SPEED/64 ? -MAX_SPEED/64 : this.vy;
